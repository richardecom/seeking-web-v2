            ...
            {loading ? (
              <ul>
                ...
                {[...Array(4)].map((_, index) => (
                  <li
                    key={index}
                    className="h-[90px] rounded-sm bg-white ring-1 ring-slate-200 shadow-sm p-3 mb-2"
                  >
                    <div>
                      <Skeleton className="w-[80px] h-[12px] mb-2" />
                      <Skeleton className="w-[120px] h-[10px] mb-2" />
              ...
              <ul>
                {/* Render actual subscription data */}
