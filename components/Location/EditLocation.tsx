...
import { UpdateLocation } from '@/hooks/LocationHooks'
...
const EditLocation = ({ locationData, onSubmit }) => {
...
useEffect(() => {
  if (locationData) {
    setFormData({
      ...
      user_id: locationData.user_id || 0,
      user_name: locationData.user.name || '',
      building: locationData.building || '',
      room: locationData.room || '',
      storage_location: locationData.storage_location || '',
  ...
  return (
    <form className="space-y-2" onSubmit={ submitUpdate }>
